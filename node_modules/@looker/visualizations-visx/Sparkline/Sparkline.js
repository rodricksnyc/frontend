...
var generatePoints = function generatePoints(_ref) {
  var data = _ref.data,
      ...
      render_null_values = _ref.render_null_values;
  var dataChunks = render_null_values ? [data] : chunkByNull(data);
...
export var Sparkline = function Sparkline(_ref2) {
  ...
  var _ref3 = config || {},
      _ref3$render_null_val = _ref3.render_null_values,
      render_null_values = _ref3$render_null_val === void 0 ? false : _ref3$render_null_val,
  ...
  var dataPoints = data === null || data === void 0 ? void 0 : data.map(function (d) {
    var val = d[firstMeasure.name];
    var nullValue = render_null_values ? Number(val) : val;
  ...
  var _ref5 = (config === null || config === void 0 ? void 0 : (_config$y_axis = config.y_axis) === null || _config$y_axis === void 0 ? void 0 : (_config$y_axis$ = _config$y_axis[0]) === null || _config$y_axis$ === void 0 ? void 0 : _config$y_axis$.range) || [],
