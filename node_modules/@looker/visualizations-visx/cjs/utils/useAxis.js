...
const useAxis = ({
  ...
  const xAxisLabels = data.map(datum => (0, _formatDateLabel.formatDateLabel)({
  ...
  const XAxisWrapped = () => {
    var _config$x_axis2, _config$x_axis2$;

    return _react.default.createElement(_Axis.XAxis, _extends({
