...
const Sparkline = ({
  ...
  const _ref = config || {},
        _ref$render_null_valu = _ref.render_null_values,
        render_null_values = _ref$render_null_valu === void 0 ? false : _ref$render_null_valu,
  ...
  const dataPoints = data === null || data === void 0 ? void 0 : data.map(d => {
  ...
  const _ref3 = (config === null || config === void 0 ? void 0 : (_config$y_axis = config.y_axis) === null || _config$y_axis === void 0 ? void 0 : (_config$y_axis$ = _config$y_axis[0]) === null || _config$y_axis$ === void 0 ? void 0 : _config$y_axis$.range) || [],
