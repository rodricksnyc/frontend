...
const Scatter = ({
  ...
  const plots = fields.measures.map((measure, i) => {
    ...
    const sizeByMax = size_by ? (0, _visualizationsAdapters.getSeriesMax)(size_by, data) : 0;
    const sizeByMin = size_by ? (0, _visualizationsAdapters.getSeriesMin)(size_by, data) : 0;
