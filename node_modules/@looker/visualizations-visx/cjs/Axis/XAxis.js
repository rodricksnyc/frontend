...
var _formatDateLabel = require("../utils/formatDateLabel");

const _excluded = ["formattedValue"];
...
const XAxis = ({
  ...
  const _useContext = (0, _react.useContext)(_xychart.DataContext),
  ...
  return _react.default.createElement(_xychart.Axis, {
    ...
    tickComponent: _ref => {
      ...
      return showTicks ? _react.default.createElement(_text.Text, tickProps, (0, _formatDateLabel.formatDateLabel)({
