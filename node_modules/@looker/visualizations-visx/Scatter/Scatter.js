...
import { concatDimensions, getX, getY, getYAxisRange, useChartTheme, useAxis, isValidChartData, getRelativeGlyphSize, getDefaultGlyphSize } from '../utils';
import { XYTooltip } from '../XYTooltip';
import { Glyph } from '../Glyph';
import { Grid } from '../Grid';
export var Scatter = function Scatter(_ref) {
  var data = _ref.data,
      config = _ref.config,
  ...
  var plots = fields.measures.map(function (measure, i) {
    ...
    var sizeByMax = size_by ? getSeriesMax(size_by, data) : 0;
    var sizeByMin = size_by ? getSeriesMin(size_by, data) : 0;
