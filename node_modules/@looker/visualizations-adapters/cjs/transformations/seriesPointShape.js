...
const seriesPointShape = ({
  config,
  data,
  fields
}) => {
  const series_point_styles = config.series_point_styles,
  ...
  const buildNamedSeries = s => {
    const namedSeries = measures.reduce((seriesConfig, field) => {
      ...
      return (0, _merge.default)(seriesConfig, defaultSeriesShape, currentFieldSettings);
    }, {});
    return namedSeries;
  };
