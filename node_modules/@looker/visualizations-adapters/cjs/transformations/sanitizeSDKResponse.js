...
exports.sanitizeSDKResponse = exports.keysToRemove = void 0;
...
const sanitizeSDKResponse = ({
  ...
  return {
    config: (0, _omit.default)(config, [...keysToRemove]),
    data,
    fields
  };
};
