...
const _excluded = ["series_colors", "series", "custom_color"],
      _excluded2 = ["color"];
...
const seriesColors = ({
  ...
  const colorSet = Array.from(new Set([...seriesColorValues, custom_color, ..._utils.DEFAULT_SERIES_COLORS])).filter(Boolean);
