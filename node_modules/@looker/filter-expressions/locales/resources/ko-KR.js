var resources = {
  describe_date: {
    ...
    'is day': '이(가) {{day}}임',
    'is from dateTimeStart until dateTimeEnd': '이(가) {{dateTimeStart}}에서 {{dateTimeEnd}}까지임',
    ...
    'is intervalStart intervalType for intervalEnd': '이(가) {{intervalEnd}}의 {{intervalStart}} {{intervalType}}임',
    ...
    'this startInterval to endInterval': '이 {{startInterval}}부터 {{endInterval}}까지',
