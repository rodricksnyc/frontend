var resources = {
  describe_date: {
    ...
    'is before': 'อยู่ก่อน',
    'is day': 'เป็น {{day}}',
    'is from dateTimeStart until dateTimeEnd': 'ตั้งแต่ {{dateTimeStart}} จนถึง {{dateTimeEnd}}',
    ...
    'is intervalStart intervalType for intervalEnd': 'อยู่ตั้งแต่ {{intervalStart}} {{intervalType}} เป็นเวลา {{intervalEnd}}',
    ...
    'this startInterval to endInterval': '{{startInterval}} นี้ถึง {{endInterval}}',
