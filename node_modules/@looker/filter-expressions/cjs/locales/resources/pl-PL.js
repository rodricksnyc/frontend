...
const resources = {
  describe_date: {
    ...
    'is day': 'jest {{day}}',
    'is from dateTimeStart until dateTimeEnd': 'jest od {{dateTimeStart}} do {{dateTimeEnd}}',
    ...
    'is intervalStart intervalType for intervalEnd': 'jest {{intervalStart}} {{intervalType}} dla {{intervalEnd}}',
    ...
    'this startInterval to endInterval': 'ten {{startInterval}} do {{endInterval}}',
