...
const resources = {
  describe_date: {
    ...
    'is day': 'ist {{day}}',
    'is from dateTimeStart until dateTimeEnd': 'ist vom {{dateTimeStart}} bis zum {{dateTimeEnd}}',
    ...
    'is intervalStart intervalType for intervalEnd': 'ist {{intervalStart}} {{intervalType}} für {{intervalEnd}}',
    ...
    'this startInterval to endInterval': 'diese/r/s {{startInterval}} bis {{endInterval}}',
