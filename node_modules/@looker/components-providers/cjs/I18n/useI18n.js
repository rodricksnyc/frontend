...
exports.useI18n = exports.i18nUpdate = exports.i18nInit = exports.i18nInitOptions = void 0;
...
const i18nInitOptions = {
  ...
  resources: _resources.i18nResources,
  saveMissing: true
};
exports.i18nInitOptions = i18nInitOptions;

const i18nInit = function () {
  var _ref = _asyncToGenerator(function* (initOptions = i18nInitOptions) {
    return _i18next.default.use(_reactI18next.initReactI18next).init(initOptions);
  });
