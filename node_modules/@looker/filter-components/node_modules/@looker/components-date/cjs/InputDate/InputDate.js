...
const InputDate = (0, _react.forwardRef)(({
  ...
  const _useState5 = (0, _react.useState)(selectedDate ? (0, _locale.formatDateString)(selectedDate, dateStringFormat, locale) : ''),
  ...
  const handleDayClick = date => {
    setTextInputValue((0, _locale.formatDateString)(date, dateStringFormat, locale));
  ...
  (0, _react.useEffect)(() => {
    if (value && !(0, _isEqual.default)(value, selectedDate)) {
      ...
      value && setTextInputValue((0, _locale.formatDateString)(value, dateStringFormat, locale));
  ...
  return _react.default.createElement(InputDateWrapper, null, _react.default.createElement(_components.InputText, {
    "aria-describedby": ariaDescribedby,
    "aria-labelledby": ariaLabelledby,
    placeholder: `${t('Date')} (${(0, _locale.formatDateString)(new Date(Date.now()), dateStringFormat, locale)})`,
