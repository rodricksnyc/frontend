...
const InputDateRange = (0, _react.forwardRef)(({
  ...
  (0, _components.useReadOnlyWarn)('InputDateRange', value, onChange);
  ...
  const _useState5 = (0, _react.useState)(calView),
  ...
  const _useState7 = (0, _react.useState)((0, _locale.formatDateString)(dateRange.from, dateStringFormat, locale)),
  ...
  const fromID = (0, _components.useID)(id && `from-${id}`);

  const _useState11 = (0, _react.useState)((0, _locale.formatDateString)(dateRange.to, dateStringFormat, locale)),
  ...
  const toID = (0, _components.useID)(id && `to-${id}`);
  const inputs = {
    from: {
  ...
  (0, _react.useEffect)(() => {
    if (value && !(0, _isEqual.default)(value, dateRange)) {
      setDateRange(value);
      value.from && inputs.from.setValue((0, _locale.formatDateString)(value.from, dateStringFormat, locale));
      value.to && inputs.to.setValue((0, _locale.formatDateString)(value.to, dateStringFormat, locale));
  ...
  const handleDateChange = (datesToSet, date) => {
    ...
    inputs[nonActiveInput].setValue((0, _locale.formatDateString)(newDateRange[nonActiveInput], dateStringFormat, locale));
  ...
  const handleCalendarClick = date => {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        const d = _step.value;
        inputs[d].setValue((0, _locale.formatDateString)(date, dateStringFormat, locale));
      }
    } catch (err) {
      _iterator.e(err);
    } finally {
  ...
  const _formatMonthTitle = (0, _Calendar.formatMonthTitle)(locale);
  ...
  }, _react.default.createElement(_components.VisuallyHidden, {
    id: startDateLabelledby
  }, t('Start date')), _react.default.createElement(_components.InlineInputTextBase, {
    placeholder: `${(0, _locale.formatDateString)(new Date(Date.now()), dateStringFormat, locale)}`,
    disabled: disabled,
  ...
  }, t('End date')), _react.default.createElement(_components.InlineInputTextBase, {
    placeholder: (0, _locale.formatDateString)(new Date(Date.now()), dateStringFormat, locale),
    disabled: disabled,
    fontSize: "small",
  ...
  }), inputs.from.isValid && inputs.to.isValid || _react.default.createElement(_components.InputTextContent, {
    pr: "u2"
  }, _react.default.createElement(_components.ErrorIcon, null))), _react.default.createElement(MultiCalendarLayout, null, _react.default.createElement(_components.VisuallyHidden, {
    "aria-live": "assertive"
...
})(["", " align-items:stretch;display:grid;font-family:", ";grid-template-columns:auto auto auto 1fr;height:", ";padding:", ";width:100%;&:hover{", "}&:focus-within{", "}", " ", " ", "{justify-self:right;}input{font-family:inherit;}", "{margin:", " 0;&:focus-within{background:", ";}input,span{padding:0 ", ";}}"], _components.inputCSS, ({
  theme
}) => theme.fonts.body, _components.inputHeight, ({
  theme: {
    space
  }
}) => `${space.u05} ${space.u1}`, _components.inputTextHover, _components.inputTextFocus, _components.inputTextValidation, ({
  disabled
}) => disabled && _components.inputTextDisabled, _components.InputTextContent, _components.InlineInputTextBase, ({
  theme
}) => theme.space.u05, ({
  theme
