...
import { Combobox, ComboboxInput, ComboboxList, ComboboxOption, pickAriaAndValidationProps, useReadOnlyWarn } from '@looker/components';
...
var InputTimeSelectLayout = forwardRef(function (_ref, ref) {
  ...
  var throttledHandleChange = useMemo(function () {
    return throttle(function (newSelectedOption) {
