...
export var InputDateRange = forwardRef(function (_ref, ref) {
  ...
  var _useState7 = useState(formatDateString(dateRange.from, dateStringFormat, locale)),
  ...
  var _useState11 = useState(formatDateString(dateRange.to, dateStringFormat, locale)),
  ...
  useEffect(function () {
    if (value && !isEqual(value, dateRange)) {
      setDateRange(value);
      value.from && inputs.from.setValue(formatDateString(value.from, dateStringFormat, locale));
      value.to && inputs.to.setValue(formatDateString(value.to, dateStringFormat, locale));
  ...
  var handleDateChange = function handleDateChange(datesToSet, date) {
    ...
    inputs[nonActiveInput].setValue(formatDateString(newDateRange[nonActiveInput], dateStringFormat, locale));
  ...
  return React.createElement(InputDateRangeWrapper, {
    ...
    placeholder: "".concat(formatDateString(new Date(Date.now()), dateStringFormat, locale)),
    disabled: disabled,
    ...
    placeholder: formatDateString(new Date(Date.now()), dateStringFormat, locale),
    disabled: disabled,
    fontSize: "small",
