...
export var StringFilter = function StringFilter(_ref) {
  ...
  var stringFilterOptions = useStringFilterOptions();
  var options = useFilterOptions(stringFilterOptions, showMatchesAdvanced);
  ...
  var FilterComponent = stringFilterTypeToFilter(item.type);
