...
export var RelativeTimeframePresets = function RelativeTimeframePresets(props) {
  var _useTranslation = useTranslation('RelativeTimeframePresets'),
      t = _useTranslation.t;
...
var PresetTimeframeGroup = function PresetTimeframeGroup(_ref) {
  var _ref$duration = _ref.duration,
      ...
      value = _ref.value;
  var presets = useRelativeTimeframePresets();
  ...
  return React.createElement(React.Fragment, null, Object.values(presetTimeframe).map(function (timeframe, index) {
...
var CustomMenuItem = styled(MenuItem).withConfig({
  displayName: "RelativeTimeframePresets__CustomMenuItem",
  componentId: "sc-1lkgww6-0"
})(["& > button{&[aria-current='true']{background-color:", ";", "{color:", ";}}&:hover{background-color:", ";}}"], function (_ref2) {
