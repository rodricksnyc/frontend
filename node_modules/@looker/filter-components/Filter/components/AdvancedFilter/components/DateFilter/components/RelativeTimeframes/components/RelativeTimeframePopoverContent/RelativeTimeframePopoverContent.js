...
export var RelativeTimeframePopoverContent = function RelativeTimeframePopoverContent(_ref) {
  ...
  var _useTranslation = useTranslation('RelativeTimeframePopoverContent'),
      t = _useTranslation.t;
