...
exports.useFiscalPastUnits = exports.usePastUnits = void 0;
...
const useCompleteDateUnits = () => {
  const _useTranslation = (0, _reactI18next.useTranslation)('past_units'),
        t = _useTranslation.t;
...
const useFiscalPastUnits = () => {
  const _useTranslation2 = (0, _reactI18next.useTranslation)('past_units'),
