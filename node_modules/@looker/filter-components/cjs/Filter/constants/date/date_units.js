...
const useDateUnits = () => {
  const _useTranslation = (0, _reactI18next.useTranslation)('date_units'),
        t = _useTranslation.t;
...
const useFiscalDateUnits = () => {
  const _useTranslation2 = (0, _reactI18next.useTranslation)('date_units'),
