...
const useAgoDateUnits = () => {
  const _useTranslation = (0, _reactI18next.useTranslation)('before_after_units'),
        t = _useTranslation.t;
...
const useFromNowDateUnits = () => {
  const _useTranslation2 = (0, _reactI18next.useTranslation)('before_after_units'),
...
const useFiscalBeforeOrAfterUnits = () => {
  const _useTranslation3 = (0, _reactI18next.useTranslation)('before_after_units'),
