...
const _excluded = ["ast", "expressionType", "validationMessage", "dispatchConfigTypeChange"],
      _excluded2 = ["onInputChange", "options", "max"];
...
const ControlFilter = _ref => {
  ...
  const config = adapterProps.config,
        field = adapterProps.field;

  const _getControlFilterInfo = (0, _utils.getControlFilterInfo)((0, _get_filter_token_item.getFilterTokenItem)(ast, expressionType, config.type), adapterProps),
  ...
  const filterTokenInputChange = filterTokenProps.onInputChange,
        options = filterTokenProps.options,
        max = filterTokenProps.max,
        restProps = _objectWithoutProperties(filterTokenProps, _excluded2);

  return _react.default.createElement(Component, _extends({
    options: max ? (0, _take.default)(options, max) : options,
