...
const RelativeTimeframePresets = props => {
  const _useTranslation = (0, _reactI18next.useTranslation)('RelativeTimeframePresets'),
        t = _useTranslation.t;
  ...
  return _react.default.createElement(_components.MenuList, {
    density: -1,
    iconGutter: true
  }, showMore ? _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(PresetTimeframeGroup, _extends({}, props, {
    presetTimeframe: _relative_timeframe_types.PresetTimeframesMostRecent,
    delay: "rapid"
  })), _react.default.createElement(PresetTimeframeGroup, _extends({}, props, {
    ...
    delay: "intricate"
  }))) : _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(PresetTimeframeGroup, _extends({}, props, {
...
const PresetTimeframeGroup = ({
  ...
  const presets = (0, _get_relative_timeframe_presets.useRelativeTimeframePresets)();

  const _useContext = (0, _react.useContext)(_components.DialogContext),
  ...
  return _react.default.createElement(_react.default.Fragment, null, Object.values(presetTimeframe).map((timeframe, index) => {
...
const CustomMenuItem = (0, _styledComponents.default)(_components.MenuItem).withConfig({
  displayName: "RelativeTimeframePresets__CustomMenuItem",
  componentId: "sc-1lkgww6-0"
})(["& > button{&[aria-current='true']{background-color:", ";", "{color:", ";}}&:hover{background-color:", ";}}"], ({
  theme: {
    colors
  }
}) => colors.background, _components.Icon, ({
  theme: {
    colors
  }
}) => colors.key, ({
