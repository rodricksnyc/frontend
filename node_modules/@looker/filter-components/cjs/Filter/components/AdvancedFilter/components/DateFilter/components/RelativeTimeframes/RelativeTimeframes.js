...
const RelativeTimeframes = ({
  ...
  const internalPopoverInstanceRef = (0, _react.useRef)();

  const _useTranslation = (0, _reactI18next.useTranslation)('RelativeTimeframe'),
        t = _useTranslation.t;
  ...
  const popoverContent = _react.default.createElement(_RelativeTimeframePopoverContent.RelativeTimeframePopoverContent, {
    value: value,
    onNav: handleNav,
  ...
  const _usePopover = (0, _components.usePopover)(popoverProps),
  ...
  const label = (0, _relative_timeframe_to_string.useRelativeTimeframeToString)(value);

  const overlayTrigger = _react.default.createElement(_components.ChipButton, {
    ref: ref,
    onClick: open
  }, label);
