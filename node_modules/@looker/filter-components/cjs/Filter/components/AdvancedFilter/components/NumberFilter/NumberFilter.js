...
const NumberFilter = _ref => {
  ...
  const numberFilterOptions = (0, _utils.useNumberFilterOptions)();
  const options = (0, _utils.useFilterOptions)(numberFilterOptions, showMatchesAdvanced);
  ...
  const FilterComponent = (0, _number_filter_type_to_filter.numberFilterTypeToFilter)(item.type);
  ...
  const _useTranslation = (0, _reactI18next.useTranslation)('NumberFilter'),
        t = _useTranslation.t;
