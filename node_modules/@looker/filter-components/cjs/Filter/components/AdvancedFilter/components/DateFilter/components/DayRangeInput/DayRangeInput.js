...
const DayRangeInput = ({
  ...
  return _react.default.createElement(_components.Popover, {
    content: _react.default.createElement(InputWrapper, null, _react.default.createElement(_componentsDate.InputDateRange, {
...
})(["padding:", ";& > div{display:flex;flex-direction:column;}"], ({
  theme
}) => theme.space.small);
