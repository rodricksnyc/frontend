...
const StringFilter = _ref => {
  ...
  const stringFilterOptions = (0, _utils.useStringFilterOptions)();
  const options = (0, _utils.useFilterOptions)(stringFilterOptions, showMatchesAdvanced);

  const typeChange = value => onChange(item.id, (0, _filterExpressions.sanitizeString)(_objectSpread(_objectSpread({}, item), (0, _filterExpressions.convertOptionToType)(String(value))), userAttributes));

  const FilterComponent = (0, _string_filter_type_to_filter.stringFilterTypeToFilter)(item.type);
