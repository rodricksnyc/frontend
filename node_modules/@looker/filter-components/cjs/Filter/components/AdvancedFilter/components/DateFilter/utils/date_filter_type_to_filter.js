...
var _UserAttribute = require("../../UserAttribute/UserAttribute");
...
const filterTypeToDateMap = {
  ...
  user_attribute: _UserAttribute.UserAttribute
};

const dateFilterTypeToFilter = type => (0, _defaultTo.default)(filterTypeToDateMap[type], _MatchesAdvanced.MatchesAdvanced);
